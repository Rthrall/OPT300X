 ...
 * @return 0 in case of success, or a negative error code otherwise.
 */
int opt300x::register_write(const enum opt300x_register reg_address, const uint16_t reg_content) {
    int res;
 ...
 * @return 0 on success, -EIO on I2C communication failure
 */
int opt300x::conversion_continuous_enable(void) {
    int res;
 ...
 * @return 0 on success, -EIO on I2C communication failure
 */
int opt300x::conversion_continuous_disable(void) {
    int res;
 ...
 * @return 0 on success, -EIO on I2C communication failure
 */
int opt300x::conversion_singleshot_trigger(void) {
    int res;
